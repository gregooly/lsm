...
public class DeliveryJobDetailViewModel
{
    ...
    public IReadOnlyList<DeliveryExpectedItemRowViewModel> ExpectedItems { get; init; } = [];
    public IReadOnlyList<DeliveryScanEventRowViewModel> RecentScans { get; init; } = [];
}

public class DeliveryExpectedItemRowViewModel
{
...
public class DeliveryScanEventRowViewModel
{
